...
└── assets/
    ...
    ├── themes/            Built-in theme palettes (19 total; full list in theme.js THEMES)
    ...
    │   ├── gen-art{,-dark}.css    Generative tiles + oversized numerals (design-driven)
